	                      ...
	                      <tbody>
							<c:forEach items="${gradedExamsWithOutcome}" var="exam">
								<tr>
									...
									<td><span class="sparklines" sparkType="bar" sparkBarColor="green">${exam.gradesOverview[0]},${exam.gradesOverview[1]},${exam.gradesOverview[2]},${exam.gradesOverview[3]},${exam.gradesOverview[4]}</span><span class="pull-right">&emsp;Average Grade: <fmt:formatNumber value="${exam.averageGrade}" maxFractionDigits="2"/></span></td>
