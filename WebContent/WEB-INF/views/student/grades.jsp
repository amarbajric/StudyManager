                  ...
                  <div class="x_content">
                    ...
                    <div id="datatable-buttons_wrapper" class="dataTables_wrapper form-inline dt-bootstrap no-footer">
                      <table id="datatable-buttons" class="table table-striped table-bordered dataTable no-footer dtr-inline" role="grid" aria-describedby="datatable-buttons_info" style="width: 1585px;">
	                      <thead>
	                        <tr role="row">
	                        <th class="sorting" tabindex="0" aria-controls="datatable-buttons" rowspan="1" colspan="1" style="maxWidth: 600px;minWidth:350px;" aria-label="Name of the Course">Course</th>
	                        <th class="sorting" tabindex="0" aria-controls="datatable-buttons" rowspan="1" colspan="1" style="maxWidth: 250px;minWidth:150px;" aria-label="Type of the Exam (e.g. final or mid-term)">Exam Type</th>
	                        <th class="sorting" tabindex="0" aria-controls="datatable-buttons" rowspan="1" colspan="1" style="maxWidth: 2500px;minWidth:150px;" aria-label="Attempt number of the exam">Attempt</th>
	                        <th class="sorting_desc" tabindex="0" aria-controls="datatable-buttons" rowspan="1" colspan="1" style="maxWidth: 250px;minWidth:150px;" aria-sort="descending" aria-label="Date of the exam">Date</th>
	                        <th class="sorting" tabindex="0" aria-controls="datatable-buttons" rowspan="1" colspan="1" style="maxWidth: 250px;minWidth:150px;" aria-label="Grade of the exam">Grade</th>
	                        <th class="sorting" tabindex="0" aria-controls="datatable-buttons" rowspan="1" colspan="1" style="minWidth: 300px;maxWidth: 400px;">Outcome</th>
	                        </tr>
	                      </thead>
	                      ...
	                      <tbody>
							<c:forEach items="${gradedExamsWithOutcome}" var="exam">
								<tr>
									...
									<td><span class="sparklines" sparkType="bar" sparkBarColor="green">${exam.gradesOverview[0]},${exam.gradesOverview[1]},${exam.gradesOverview[2]},${exam.gradesOverview[3]},${exam.gradesOverview[4]}</span>
									<span class="pull-right">&emsp;Average Grade: <fmt:formatNumber value="${exam.averageGrade}" maxFractionDigits="2"/></span></td>
